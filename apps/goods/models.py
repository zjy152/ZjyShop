...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True,
                                        related_name='sub_cat',help_text="父目录",verbose_name="父类目级别")
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(imagePath='goods/images/', width=1000, height=300, filePath='goods/files/',
                              default='', verbose_name= u'内容')
    ship_free = models.BooleanField(default=True, verbose_name='是否承担运费')
    # 首页中的展示的商品封面图
    goods_front_image = models.ImageField(upload_to='goods/images/', null=True, blank=True, verbose_name='轮播图')
    # 首页中的新品展示
